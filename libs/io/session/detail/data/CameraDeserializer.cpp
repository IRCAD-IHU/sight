...
) const
{
    ...
    readVersion<sight::data::Camera>(tree, 0, 1);
    ...
    camera->setDescription(readString(tree, "Description"));
    camera->setCameraID(readString(tree, "CameraID"));
    ...
    camera->setVideoFile(readString(tree, "VideoFile"));
    camera->setStreamUrl(readString(tree, "StreamUrl"));
