...
class ListSerializer : public IDataSerializer
{
public:

    SIGHT_DECLARE_CLASS(ListSerializer, IDataSerializer);

    /// Delete default copy constructors and assignment operators
    ListSerializer(const ListSerializer&)            = delete;
    ListSerializer(ListSerializer&&)                 = delete;
    ListSerializer& operator=(const ListSerializer&) = delete;
    ListSerializer& operator=(ListSerializer&&)      = delete;

    /// Default constructor
    ListSerializer() = default;

    /// Default destructor
    ~ListSerializer() override = default;
