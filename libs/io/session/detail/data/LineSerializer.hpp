...
class LineSerializer : public IDataSerializer
{
public:

    SIGHT_DECLARE_CLASS(LineSerializer, IDataSerializer);

    /// Delete default copy constructors and assignment operators
    LineSerializer(const LineSerializer&)            = delete;
    LineSerializer(LineSerializer&&)                 = delete;
    ...
    /// Default destructor
    ~LineSerializer() override = default;
