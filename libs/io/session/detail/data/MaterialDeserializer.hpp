...
class MaterialDeserializer : public IDataDeserializer
{
public:

    SIGHT_DECLARE_CLASS(MaterialDeserializer, IDataDeserializer);
    ...
    /// Default constructor
    MaterialDeserializer() = default;

    /// Default destructor
    ~MaterialDeserializer() override = default;
